...
public class Level3Bossball : MonoBehaviour
{
   [Header("============= Object =============")]
    ...
    public float RemoteAttackDistance;
    public int runSpeed;
    ...
    void distancechange(float angle)
   {
        ...
        else if(distance<=RemoteAttackDistance){
            transform.LookAt(player.transform.position);
            nowstate = 3;
        }
    ...
    public void attackPlayer02()
    {
        ...
        // }
        // Debug.Log("instaniate a ball!");
        Vector3 pos = transform.position;
        pos.y = pos.y+0.5f;
        GameObject gameObject =  Instantiate(remoteObjct,pos,transform.rotation);
        // Debug.Log(transform.position+" rotation: "+transform.rotation);
